...
def verify_signature(received_signature: str, payload):
    HMAC_KEY = 'DF42E0CDDDEABBC182E7297FC4C0206B'
    HMAC_STRING_KEYS = [
    ...
    hmac_string = ''.join(str(flat_payload[key]) for key in HMAC_STRING_KEYS).replace(
...
received_signature = '6965eb228a2ee5003f9dc01528d68271fdbeae7af0e5bbb1d4915cecff675c2fcb3f08aec78e5859e198ca2b1e53c622a7b5ab7dcb9d15b6ab051a25d1ea1a74'
print(verify_signature(received_signature=received_signature, payload=payload))
